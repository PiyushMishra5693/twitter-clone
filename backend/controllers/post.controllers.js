...
export const deletePost = async(req,res)=>{
    ...
    try {
        ...
        console.log("Error in delte post controller: ",error.message);
        res.status(500).json({error:"Internal Server Error"});
    }
}
...
export const commentOnPost = async(req,res)=>{
    ...
    try {
        ...
        if(!text){
            return res.status(400).json({error:"Text feilds are required"});
        }
...
export const getUserPosts = async(req,res)=>{
    ...
    try {
        ...
        console.log("Error in getUser Post controller:",error.message);
        res.status(500).json({error:"Internal server error"});
    }
}